...
import com.project.wild.common.constant.Constants;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    @Autowired
    private UserService apeUserService;
    ...
    */
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        if (principals != null) {
            apeUser = (User) principals.getPrimaryPrincipal();
    ...
    */
    public User checkUserTokenIsEffect(String token) throws AuthenticationException {
        ...
        // 查询用户信息
        User loginUser = apeUserService.getById(userId);
        if (loginUser == null) {
