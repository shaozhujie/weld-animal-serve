package com.project.wild.config.aspectj;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONObject;
import com.project.wild.common.annotation.Log;
import com.project.wild.common.enums.BusinessStatus;
import com.project.wild.config.event.LogEvent;
import com.project.wild.config.utils.RequestUtils;
import com.project.wild.config.utils.ServletUtils;
...
public class LogAspect {
     ...
     */
    @Pointcut("@annotation(com.project.wild.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            User currentUser = ShiroUtils.getUserInfo();
    ...
    public void getControllerMethodDescription(Log log, OperateLog operLog) throws Exception {
        // 设置action动作
    ...
    private void setRequestValue(OperateLog operLog) throws Exception {
